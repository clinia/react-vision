      ...
      results: [
        {
          ...
          meta: {
            query: '',
            params: 'query=&perPage=10&page=0&facets=%5B%5D&tagFilters=',
            took: 4,
            page: 0,
            numPages: 0,
            perPage: 10,
...
describe('client hydratation', () => {
  ...
  it("does not hydrate the `searchClient` if it's not an Clinia client", () => {
    const searchClient = {
      _useCache: true,
      cache: {},
    };

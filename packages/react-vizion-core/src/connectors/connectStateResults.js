 ...
 * @kind connector
 * @providedPropType {object} searchState - The search state of the vizion component.
 ...
 * @providedPropType {boolean} isSearchStalled - Flag that indicates if React Vizion has detected that searches are stalled.
 * @providedPropType {object} props - component props.
 * @example
 * import React from 'react';
 * import clinia from 'clinia/lite';
 * import { Vizion, SearchBox, Hits, connectStateResults } from '@clinia/react-vizion-dom';
 *
